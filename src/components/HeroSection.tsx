        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-72 h-72 md:w-96 md:h-96 rounded-full border-4 md:border-8 border-blue-500 opacity-80" />
            </div>
            ...
            {/* Portrait Image */}
            <div className="relative z-10 w-56 h-56 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-slate-700 shadow-2xl">
              <img
